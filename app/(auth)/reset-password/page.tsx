        ...
        boxShadow: "-2px 1px 10px rgba(255, 255, 255, 0.1)"
            ...
            <div className="bg-black flex flex-col justify-center items-center md:space-y-10 space-y-8 lg:w-3/4 w-full h-full py-12 overflow-hidden font-display">
                <div className="flex flex-col items-start lg:w-[45%] w-[80%] space-y-2">
                    <h1 className="font-bold md:text-3xl text-xl font-sans tracking-tight text-nowrap">{t('resetPassword.title')}</h1>
                    <h3 className="font-semibold md:text-md text-xs text-muted-foreground tracking-tight text-nowrap">{t('resetPassword.subtitle')}</h3>
                </div>
...
export default function ResetPasswordPage() {
    return (
        <Suspense fallback={<div className="h-screen bg-black/90" />}>

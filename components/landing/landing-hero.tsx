    ...
    return (
      <section ref={sectionRef} className="min-h-screen bg-black pt-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 reveal">
          ...
          {/* Headline */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white text-center mb-6 leading-tight font-display reveal">
            {t('hero.title1')}{' '}
          ...
          {/* Subheading */}
          <p className="text-lg sm:text-xl text-muted-foreground text-center mb-12 max-w-2xl mx-auto font-display reveal">
            {t('hero.description')}
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20 font-display reveal">
            <Link
              href="/register"
